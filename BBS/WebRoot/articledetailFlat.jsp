...
<%
	...
	ResultSet rs = DB.executeQuery(stmt,sql);  //要先写好sql语句，如果在这行代码加入sql语句，会由于忘记加引号，造成空指针错误。
	while(rs.next()){
...
<div id="jive-flatpage">
  ...
  <div class="jive-buttons">
    <table summary="Buttons" border="0" cellpadding="0" cellspacing="0">
      <tbody>
        <tr>
          <td class="jive-icon"><a href="http://bbs.chinajavaworld.com/post%21reply.jspa?threadID=744236"><img src="articledetail_files/reply-16x16.gif" alt="回复本主题" border="0" height="16" width="16"></a></td>
                                ...
                                <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tbody>
                                      <tr valign="top">
                                        ...
                                        <td style="padding: 0px;" width="99%"><img class="jive-status-level-image" src="articledetail_files/level3.gif" title="世界新手" alt="" border="0"><br>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                ...
                                <td width="1%"><div class="jive-buttons">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td class="jive-icon"><a href="http://bbs.chinajavaworld.com/post%21reply.jspa?messageID=780144" title="回复本主题"><img src="articledetail_files/reply-16x16.gif" alt="回复本主题" border="0" height="16" width="16"></a> </td>
